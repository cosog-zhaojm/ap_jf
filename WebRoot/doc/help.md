...
![](../images/helpdoc/PNG/9e34999273d068955e94da0ef08d337b.png)

4、驱动程序路径配置，只需将IP修改为驱动程序所在服务器IP即可。

![](../images/helpdoc/PNG/4f4d00a798e4a97c7908add773f81bb5.png)
...
![](../images/helpdoc/PNG/4879524afa35b5c6325107a8072f5345.png)

软件界面是否显示图标(如中石油、中石化等单位logo)，false-不显示；true-显示。

7、是否打印日志

![](../images/helpdoc/PNG/9f3c55ee5e3e7a1d95755b03fd6040fd.png)

是否打印日志，false-不打印（非调试模式推荐使用）；true-打印。

8、是否发送模拟数据，用于演示

![](../images/helpdoc/PNG/6d6715e95539edee380162869f18b907.png)
...
![](../images/helpdoc/PNG/25550dfa93d0795afbf559211799441e.png)

2、软件简介配置

同步修改tomcat安装目录\\webapps\\ap\\WEB-INF\\config\\config.yml和tomcat安装目录\\webapps\\ap\\WEB-INF\\classes\\config\\config.yml文件

![](../images/helpdoc/PNG/4a7f2abad4bbc4bfade9defae7accf12.png)
...
![](../images/helpdoc/PNG/ce7300170c5f8737863afb21572715bc.png)
...
（1）图标：替换tomcat安装目录\\webapps\\ap\\images路径下“password.svg”图片；
...
![](../images/helpdoc/PNG/12e219145a93ad53c779a5f44119a35a.png)
...
![](../images/helpdoc/PNG/974d7836020df59de6fa39865ea52f86.png)
...
![](../images/helpdoc/PNG/c96784256910983f8045eaf1b1e91787.png)
...
例如：修改rpc01井井，采集时间为2022-06-12
11:12:32的的记录原油密度数据并重新计算。

操作：修改表中参数，点击“修改数据计算”按钮。

![](../images/helpdoc/PNG/652bb5ed84dcf2667ae4650c830a4fcb.png)
...
例如：在“井名信息”模块中，修改了rpc01井的生产数据，并将2022-06-01至2022-06-12区间内的历史数据应用改后的生产数据，重新计算。

操作：设备列表中选择rpc01（如果未选中某口井，将会重新计算所选组织下所有井在某时间段内的数据），时间范围2022-06-01至2022-06-12，点击“关联数据计算”。弹出操作确认对话框，确认无误后点击“是”。这时，rpc01井2022-06-01至2022-06-12的所有历史数据将按最新的生产数据进行重新计算。

![](../images/helpdoc/PNG/223e7faf3e1b60e4cff75e81c4e94ba1.png)
...
![](../images/helpdoc/PNG/954c49ab0e3dc838ed503d380710b523.png)
...
![](../images/helpdoc/PNG/0a45bf2dd72b649681ef16f644e15091.png)
...
![](../images/helpdoc/PNG/5457f3199b1afaf308773277c2cf958f.png)
...
![](../images/helpdoc/PNG/2d8ff51fd7cc5267394ac6281152bb5a.png)
...
![](../images/helpdoc/PNG/9ae3ef68af6188b218b1c7a24aa730bc.png)
...
![](../images/helpdoc/PNG/7358f6ccbbe33659cf189b77affe782a.png)
...
![](../images/helpdoc/PNG/3bdcfaeabee0b7e9dd3974c4626ca7ef.png)
...
![](../images/helpdoc/PNG/4870d1eaa112dba301d586d0b4697da0.png)
...
![](../images/helpdoc/PNG/aa1bc76c6f06ca75e8c69daa6ad580d7.png)
...
![](../images/helpdoc/PNG/5bdf11c976bcdaecf9e47f2273e64249.png)
...
![](../images/helpdoc/PNG/48a6034a5284a18b24945618e537e3cc.png)
...
![](../images/helpdoc/PNG/fff78e352f0ad850a00440b640a2c115.png)
...
![](../images/helpdoc/PNG/54f57b568e0c7ae7c48f047a40012293.png)
...
![](../images/helpdoc/PNG/113e0e642f22533e1ab57572e35ab212.png)
...
![](../images/helpdoc/PNG/8eb8f139c535ca81b4fb5a9739340178.png)
...
![](../images/helpdoc/PNG/00947d491171fe1555a391d6077d7523.png)
...
![](../images/helpdoc/PNG/684e6a809c8d7f773fb939e45e4f1411.png)
...
![](../images/helpdoc/PNG/fbba93871def02eb40747631059af439.png)
...
![](../images/helpdoc/PNG/ca90694c0726a1cd8444c9c3d3eb83c6.png)
...
![](../images/helpdoc/PNG/c3cfd1d28b3e26054c5dc2d4833d66da.png)
...
![](../images/helpdoc/PNG/f2b0491d37733c747180fd0c9305dc69.png)
...
![](../images/helpdoc/PNG/a9156b1694353f8017cae8e05c47e8d2.png)
...
![](../images/helpdoc/PNG/d78e5d0cb35df970ec3d54061988d2e1.png)
...
![](../images/helpdoc/PNG/dcdf60e3ed67c00ad0f95a666b34e94a.png)
...
### <h3><a name="2.9.1 组织用户"></a>2.9.1组织用户</h3>

单位组织以及用户维护，用户列表中带\*的用户为当前登录用户。只能查看当前登录用户自己以及角色等级小于自己的其他用户。

![](../images/helpdoc/PNG/c299e6ec2c658133186c48a6fe2e5b18.png)
...
![](../images/helpdoc/PNG/4db401d769897d3e9863e1330ab02607.png)
...
![](../images/helpdoc/PNG/5bd56e2da1e1b0033e07efe3105c0f65.png)
...
![](../images/helpdoc/PNG/5a4b432942d30f463f64298f629cbd7f.png)

图2-101用户删除

#### <h4><a name="2.9.1.7用户隶属迁移"></a>2.9.1.7 用户隶属迁移</h4>
...
![](../images/helpdoc/PNG/379c42dc2da91d407ff0980c6e634d81.png)
...
![](../images/helpdoc/PNG/bdf66ed3ea0628120c17879ac5d89d2c.png)
...
![](../images/helpdoc/PNG/358ed64d323aac35904dc29f3c6067b3.png)
...
![](../images/helpdoc/PNG/e6f6bf285bb26de4406367e11db4ec45.png)
...
![](../images/helpdoc/PNG/d8aa9824cc131d5f42e3757e17c6f036.png)
